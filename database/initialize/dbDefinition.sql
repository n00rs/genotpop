...
CREATE INDEX IF NOT EXISTS idx_category_code_and_name ON tbl_category(
  vchr_category_code,
  vchr_category_name,
  chr_document_status
) WHERE
...
CREATE UNIQUE INDEX IF NOT EXISTS tbl_customer_vchr_customer_code_key ON tbl_customer(vchr_customer_code)
WHERE
  chr_document_status = 'N';
